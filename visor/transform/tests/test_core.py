...
class TestCore(TestBase):
    ...
    def test_open_vsr_r(self):
        ...
        img = vtf.open_vsr(self.path, 'r')
        
        self.assertIsInstance(img, vtf.core.Image)
...
class TestResample(TestBase):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.img = vtf.open_vsr(self.path, 'r')
    ...
    def test_image_read(self):
        ...
        self.assertIsInstance(arr, vtf.core.Array)
...
class TestImageWrite(TestBase):
    ...
    def setUp(self):
        ...
        src_img = vtf.open_vsr(self.path, 'r')
    ...
    def test_image_write(self):
        ...
        dst_img = vtf.open_vsr(self.dst_path, 'w')
